Donnez ideation  personaliser au ce pkg_competences qui exciste dans le (Package 1 : Gestion des Compétences et des Modules) pour cette application (Soli-LMS) sans details.
