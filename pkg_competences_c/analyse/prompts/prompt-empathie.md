# question:
Pour le module pkg_competences de Soli-LMS, qui vise à hiérarchiser les compétences par niveaux avec une option de personnalisation des descriptions, pouvez-vous me donner une analyse d'empathie centrée sur les différents acteurs (Responsable de Formation, Formateur, Apprenant), en tenant compte des besoins et des attentes identifiés pour chaque rôle ?
donner les parties:
- Ce qu'il dit.
- Ce qu'il fait.
- Ce qu'il ressent.
