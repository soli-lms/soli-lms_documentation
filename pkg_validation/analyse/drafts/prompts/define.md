Donnez definition personaliser au ce pkg_validation qui exciste dans le (Package 2 : Interface Formateur) pour cette application (Soli-LMS) pour chaque acteur (apprenant, formateur, responsable de formation). sans detail .

description pkg_validation : Une fonctionnalité pour attribuer des niveaux de compétence et ajouter des commentaires.

Répondez en français niveau A2.
