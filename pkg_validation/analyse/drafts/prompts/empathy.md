Donnez l'empathie personaliser au ce pkg_validation qui exciste dans le (Package 2 : Interface Formateur) pour cette application (Soli-LMS) pour chaque acteur (apprenant, formateur, responsable de formation). sans detail .
