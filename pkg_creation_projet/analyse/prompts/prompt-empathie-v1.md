Donner une empathie personnalisée du sous-package `pkg-creation-Projet` qui existe dans le package 2 Interface Formateur.
Voici l'empathie et l'idéation globale de l'application Soli-LMS :

**Soli-LMS** :
Voici une analyse de l'empathie pour chaque acteur (apprenant, formateur, responsable de formation) dans l'application 
---
